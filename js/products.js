const products = [
    {
        ...
        tagline: "The fastest way to build professional apps",
        description: "A complete library with over 500 components and pre-built screens, designed to save you months of work.",
        fullDescription: "If you want to launch your project quickly, this UI kit gives you everything you need. Original Figma files, easily editable elements, and modern colors make your app look professional instantly.",
        price: "$49",
        badge: "Best Seller",
        category: "UI Kits",
    ...
    {
        id: "saas-framelayout",
        name: "Ultimate SaaS Website Template",
        tagline: "Stop guessing, start launching",
        description: "A high-converting HTML/CSS template to launch your digital product or SaaS business in hours.",
        fullDescription: "Built with conversion optimization in mind, this template includes 10+ pages, sleek animations, and a responsive design that looks stunning on every device.",
        price: "$29",
        badge: "New",
    ...
    },
    {
        ...
        tagline: "All your workspace details in one place",
        description: "The most powerful Notion template for founders and freelancers. Organize projects, finances, and tasks in seconds.",
        fullDescription: "Stop jumping between 10 different apps. Startup OS brings your roadmap, CRM, accounting, and daily tasks into one clean, aesthetic dashboard.",
        price: "$19",
        badge: "Featured",
        category: "Templates",
    ...
    },
    {
        ...
        name: "AI Advanced Prompt Library",
        tagline: "Master ChatGPT and Claude",
        description: "A curated database of 1000+ advanced prompts for copywriters, developers, and marketers.",
